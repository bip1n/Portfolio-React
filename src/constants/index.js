...
const projects = [
  {
    ...
    image: carrent,
    source_code_link: "https://github.com/bip1n/student-mis",
  },
  {
    name: "QR-Code Generator",
    description:
      "A simple web application that allows users to generate QR code from the text inputs given by the user and download the QR Code.",
    tags: [
      {
        name: "html5",
        color: "blue-text-gradient",
    ...
    image: jobit,
    source_code_link: "https://github.com/bip1n/QR-Code-Generator",
  },
  // {
  //   name: "Trip Guide",
  //   description:
